      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div style="opacity: 1; transform: none;">
            <div class="rounded-xl bg-card text-card-foreground shadow h-full border-2 hover:border-emerald-300 transition-all duration-300 hover:shadow-lg group">
              <div class="p-6">
                ...
                <p class="text-slate-600 leading-relaxed">
                  No hidden fees, no surprises. Every client sees exactly what
          ...
          <div style="opacity: 1; transform: none;">
            <div class="rounded-xl bg-card text-card-foreground shadow h-full border-2 hover:border-emerald-300 transition-all duration-300 hover:shadow-lg group">
              <div class="p-6">
                ...
                <h3 class="text-xl font-bold mb-3">Flat Pay Structure</h3>
                <p class="text-slate-600 leading-relaxed">
                  Everyone from junior to senior earns equitably. We believe in
              ...
              <div class="p-6">
                <div class="w-14 h-14 bg-gradient-to-br from-emerald-500 to-emerald-400 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-heart w-7 h-7 text-white"
                  >
                    <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path>
                  </svg>
                </div>
                <h3 class="text-xl font-bold mb-3">People First</h3>
                <p class="text-slate-600 leading-relaxed">
                  Technology serves humans, not the other way around. We build
              ...
              <div class="p-6">
                <div class="w-14 h-14 bg-gradient-to-br from-emerald-500 to-emerald-400 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-shield w-7 h-7 text-white"
                  >
                    <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path>
                  </svg>
                </div>
                <h3 class="text-xl font-bold mb-3">Ethical Standards</h3>
                <p class="text-slate-600 leading-relaxed">
                  We say no to dark patterns, data exploitation, and
                  profit-over-people practices.
                </p>
              </div>
            </div>
          </div>
