    ...
    icon: () => {
      return (
        <svg
          ...
          className="w-6 h-6 text-emerald-200 shrink-0 mt-1"
        >
      ...
      <div className="space-y-6">
        {testimonials.map((t) => (
          <div key={`${t.author}`} className="border-l-4 border-emerald-500 pl-6 py-2">
            ...
            <div>
              <div className="font-bold text-emerald-800">{t.author}</div>
...
export default function CultureSection() {
  return (
    <section
      id="culture"
      className="py-20 px-6 bg-linear-to-br from-emerald-800 to-emerald-500 text-white"
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow mb-6 bg-white/20 text-white border-white/30 hover:bg-white/20">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
